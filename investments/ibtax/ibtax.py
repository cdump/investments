...
from investments.ibtax.report_presenter import NativeReportPresenter, NdflReportPresenter, ReportPresenter
...
from investments.trades_fifo import TradesAnalyzer, FinishedTrade  # noqa: I001
...
def main():
    available_report_types: Dict[str, Type[ReportPresenter]] = {
        ...
        '3ndfl-details': NdflReportPresenter,
    }
    ...
    if os.path.abspath(args.activity_reports_dir) == os.path.abspath(args.confirmation_reports_dir):
        logging.warning('--activity-reports-dir and --confirmation-reports-dir MUST be different directories')
        return
    ...
    # todo example usage to readme
    # todo nalog.ru docs (https://github.com/cdump/investments/issues/21)
