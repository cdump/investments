...
analyze_trades_fifo_testdata = [
    ...
    # basic cases
    ([('2018-01-01', 'TEST', 100, 4.2), ('2018-01-04', 'TEST', 50, 17.5), ('2018-01-07', 'TEST', -100, 50.3)], [(1, 'TEST', 100), (1, 'TEST', -100)]),
    ([('2018-01-01', 'TEST', 100, 4.2), ('2018-01-04', 'TEST', 50, 17.5), ('2018-01-07', 'TEST', -130, 50.3)], [(1, 'TEST', 100), (1, 'TEST', 30), (1, 'TEST', -130)]),
    ([('2018-01-01', 'TEST', -100, 4.2), ('2018-01-04', 'TEST', 30, 17.5)], [(1, 'TEST', -30), (1, 'TEST', 30)]),
    # issue #8 - sell all & open short in one trade
    ([('2018-01-01', 'TEST', 10, 4.2), ('2018-01-04', 'TEST', -10, 17.5), ('2018-01-05', 'TEST', -3, 17.5)], [(1, 'TEST', 10), (1, 'TEST', -10)]),
    ([('2018-01-01', 'TEST', 10, 4.2), ('2018-01-05', 'TEST', -13, 17.5)], [(1, 'TEST', 10), (1, 'TEST', -10)]),
]
